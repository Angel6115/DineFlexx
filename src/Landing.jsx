    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full mb-16">
        <div className="bg-white dark:bg-gray-900 p-4 rounded-2xl shadow text-center">
          <img src="/images/menu.jpg" alt="Menú" className="w-full h-40 object-cover mb-3" />
          <h3 className="text-lg font-semibold mb-1">Explora el Menú</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Descubre platos exclusivos y personaliza tu experiencia.</p>
        </div>
        <div className="bg-white dark:bg-gray-900 p-4 rounded-2xl shadow text-center">
          <img src="/images/pago.jpg" alt="Pago" className="w-full h-40 object-cover mb-3" />
          <h3 className="text-lg font-semibold mb-1">Paga como prefieras</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Cuotas semanales, Apple Pay, o tu tarjeta digital.</p>
        </div>
        <div className="bg-white dark:bg-gray-900 p-4 rounded-2xl shadow text-center">
          <img src="/images/puntos.jpg" alt="Puntos" className="w-full h-40 object-cover mb-3" />
          <h3 className="text-lg font-semibold mb-1">Acumula puntos</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Gana recompensas por cada orden y recomendación.</p>
        </div>
      </div>
