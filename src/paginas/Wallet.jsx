...
export default function Wallet() {
  const { orden, total = 0, puntos = 0, credit = 0, cuotaInicial = 0, pagosMensuales = 0 } = useOrder()
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto font-sans">
      <div className="flex items-center gap-4 mb-6">
        <img src="/images/logo4.jpg" alt="DineFlexx" className="h-12 w-12 object-contain shadow" />
